...
const MyPage = () => {
    ...
    const deleteUserUrl = "http://localhost:8080/api/user/data";
        ...
        <div>
            <div className='flex flex-col mx-20 mt-8'>
                <div className='flex items-center mb-6'>
                    ...
                    <p className='ml-1 text-lg font-bold md:text-xl'>회원정보</p>
                    <img className='w-2 mx-1 md:w-3' src="img/arrow.png" alt="" />
                    <img className='mx-1 w-7 h-7 md:w-auto md:h-auto' src="img/MyPage.png" alt="" />
                    <p className='ml-1 text-lg font-bold md:text-xl'>마이페이지</p>
                </div>
                <div className='items-center h-8 bg-gray-100 rounded-lg mb-7 w-28 md:w-40 md:h-10'>
                    <Link to={'/setting/userInfo'} className='flex items-center justify-between w-full h-full'>
                ...
                <div onClick={handleShow} className='flex items-center justify-center h-8 mt-10 bg-gray-100 rounded-lg place-self-center w-28 md:w-40 md:h-10'>
                    <p>탈퇴하기</p>
                </div>
            </div>
            ...
            {show && (<div className='modal'>
                <div className='overlay'>
                    <div style={{ width: "300px" }} className="modal-content">
                        ...
                        <button className="mb-10 text-white bg-black close-modal rounded-xl" onClick={handleDelete}>
                            탈퇴하기
                        </button>
