...
<<<<<<< HEAD
    const findUser = "http://15.165.240.184:5000/api/user";
    useEffect(() => {
...
>>>>>>> 1929b13983cd03a796f06a2106ff254c084bccd4
...
<<<<<<< HEAD
    ...
    const updateUser = "http://15.165.240.184:5000/api/user/data";
    const handleSave = async () => {
        await fetch(updateUser, {
            method: "PUT",
            headers: {
    ...
    const checkPw = "http://15.165.240.184:5000/api/user/admin/IdPw";
    const updateUserPw = "http://15.165.240.184:5000/api/user/data/updateWord";
            ...
            <div className="flex flex-col mt-8 mx-20">
                <div className="flex items-center mb-6">
                    <img
                        ...
                        alt=""
                    />
                    <p className="text-lg md:text-xl font-bold ml-1">
                        회원정보
                    </p>
                    <img
                        className="mx-1 w-2 md:w-3"
                        src="img/arrow.png"
                        alt=""
                    />
                    <img
          ...
          if (resp === true) {
            fetch(updateUserPw + `/${values.id}`, {
              ...
              .then((resp) => {
                alert(resp.message);
                if (
                  resp.message === "비밀번호 변경이 성공적으로 이루어졌습니다."
                ) {
                  document.location.href = "/";
                }
              });
